                            ...
                            <div class="right__tableWrapper">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td data-label="Mã Danh Mục"><?php echo $value['madanhmuc']?></td>
                                            <td data-label="Tên"><?php echo $value['tendanhmuc']?></td>
                                            <td data-label="Xoá" class="right__iconTable"><a href="delete_cate.php?xoa=<?php echo $value['madanhmuc']?>"><img src="assets/icon-trash-black.svg" alt=""></a></td>
                                        </tr>
                                        <?php }
